...
function preecherTabela() {
    dadospizza.forEach((e, i) => {
        ...
        detalhes.innerHTML = `<button id="botaodetalhes" onclick="abrirModal('${i}')">Detalhes</button>`;
...
function abrirModal(i){
    detalhes.classList.toggle("oculto");
    document.querySelector("#id").innerHTML = `ID: ${dadospizza[i].id}`;
    document.querySelector("#nome").innerHTML = `Pizza: ${dadospizza[i].nome}`;
    document.querySelector("#descricao").innerHTML = `Descrição: ${dadospizza[i].descricao}`;
    document.querySelector("#preco").innerHTML = `Valor: ${dadospizza[i].preco}`;
}
