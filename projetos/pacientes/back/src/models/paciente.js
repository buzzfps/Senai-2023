class Paciente {
    ...
    create() {
        return `INSERT INTO paciente VALUE(default,'${this.nome}','${this.nascimento}',${this.peso},${this.altura})`
    }
    ...
    update() {
        return `UPDATE paciente SET nome = '${this.nome}', nascimento = '${this.nascimento}', peso = ${this.peso}, altura = ${this.altura} WHERE id = ${this.id}`
    }
